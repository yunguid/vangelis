...
/**
 * Every sound the player can load, in browsing order: the bare waveforms, the
 * factory bank and Patch Lab by category, then the player's own saved sounds.
 * The preset banks are imported here so they stay out of every route's first
